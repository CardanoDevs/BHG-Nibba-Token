...
interface IERC20 {
     ...
     * allowed to spend on behalf of `owner` through {transferFrom}. T
     * zero by default.
     *
...
contract NibbaToken is Context, IERC20, Ownable {
    ...
    struct MintPara {
        ...
        uint256  secondPercent;
        uint256  thirdPercent;
        uint256  fourthPercent;
        bool     state;
    }
    ...
    constructor () {
        ...
        _isExcludedFromFee[_founderAddress] = true;
    ...
    function setBurnFeePercent(uint256 fundorBurnFee) external onlyOwner {
    ...
    function _transfer(
        ...
        uint256 contractTokenBalance = balanceOf(_lpAddress);
    ...
    function _resetCommunityLockPara(uint256 fromTime, uint256 toTime, uint256 lockTime) public onlyOwner{
